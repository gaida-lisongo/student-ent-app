...
class QuestionnaireFactory {
  static Widget createWidget({
    ...
    VoidCallback? onClose, // Ajout du callback pour fermer
  }) {
    ...
    if (questionnaire.tp != null &&
        questionnaire.tp!.questionnaires.isNotEmpty) {
      return TPWidget(
    ...
    if (questionnaire.projet != null &&
        (questionnaire.projet!.contexte.isNotEmpty ||
            questionnaire.projet!.problematiques.isNotEmpty)) {
      return ProjetWidget(
    ...
    if (questionnaire.devoir != null &&
        questionnaire.devoir!.url != null &&
        questionnaire.devoir!.url!.isNotEmpty) {
      return DevoirWidget(
