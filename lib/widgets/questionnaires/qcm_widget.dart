...
class _QCMWidgetState extends ConsumerState<QCMWidget> with WidgetsBindingObserver {
  ...
  void initState() {
    super.initState();
    _shuffledQuestions = List<QCMQuestion>.from(widget.data.questions)..shuffle();
  ...
  void _handleSecurityBreach() {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      const SnackBar(
        content: Text("Sécurité: Question passée car vous avez quitté l'écran."),
          ...
          content: Column(
            ...
            children: [
              if (serverResponse == null) ...[
                ...
                const SizedBox(height: 16),
                Text(
                  serverResponse?['message'] ?? "Résolution soumise avec succès",
                  ...
                  builder: (context) {
                    try {
                      if (serverResponse?['data'] != null && 
                        ...
                        final activities = serverResponse?['data']['activities'] as List;
            ...
            if (serverResponse == null)
              ElevatedButton(
                onPressed: _isSubmitting ? null : () async {
                  ...
                  try {
                    final response = await widget.onSubmit(totalScore.toDouble());
          ...
          child: Column(
            ...
            children: [
              ...
              ...question.options.map((option) {
                final isSelected = _answers[_currentQuestionIndex] == option.text;
                ...
                return Padding(
                  ...
                  child: InkWell(
                    onTap: hasAnswered ? null : () => _submitAnswer(option.text),
              ...
              if (hasAnswered)
                ElevatedButton(
                  ...
                  child: Text(_currentQuestionIndex < _shuffledQuestions.length - 1 
                    ? "Question Suivante" 
                    : "Terminer"),
                ),
            ],
